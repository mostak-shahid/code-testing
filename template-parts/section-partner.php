...
$title = $forclient_options['sections-partner-title'];
$content = $forclient_options['sections-partner-content'];
$slides = $forclient_options['sections-partner-slides'];
$page_details = array( 'id' => get_the_ID(), 'template_file' => basename( get_page_template() ));
do_action( 'action_avobe_partner', $page_details ); 
?>
<section id="section-partner" class="<?php if(@$forclient_options['sections-partner-background-type'] == 1) echo @$forclient_options['sections-partner-background'] . ' ';?><?php if(@$forclient_options['sections-partner-color-type'] == 1) echo @$forclient_options['sections-partner-color'];?>">
					...
					<div class="row slides">
						...
						<?php foreach($slides as $slide) : ?>
							<div class="col-lg-2 col-md-4 col-sm-6 mb-4">
								<div class="slide-unit h-100 text-center position-relative wow fadeInUp" data-wow-delay="<?php echo $delay?>ms">
								<?php if ($slide['attachment_id']) : ?>
									<img class="img-fluid img-partner smooth" src="<?php echo wp_get_attachment_url( $slide['attachment_id'] ) ?>" width="<?php echo $slide['width'] ?>" height="<?php echo $slide['height'] ?>" alt="<?php echo strip_tags(do_shortcode( $slide['title'] )) ?>">
								<?php endif; ?>
